...
> - or the command : `ibmcloud login -a cloud.ibm.com -r eu-gb -g default`
...
### 2. Check 'ibmcloud ks' and 'ibmcloud cr'
...
Test to ensure kubectl has been installed.
...
We choose a unique name as our namespace to group all images in our account. **Replace <your_namespace> with a unique namespace of your choice** and not something that is related to the tutorial.
